package psp.mviel.basicasynctast;
/* Aquesta app funciona bé inclús aplicant la rotació en android */
...
public class Inici2 extends AppCompatActivity {

    static final String LABEL = "BAT";  //Per a debugar
    static final int NOMBRE_SEGONS = 5;  // Segons que durarà la nostra tasca

    static TextView missatgeInformatiu, percentatge;
    static ProgressBar barraDeProgres;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botoCancelar = (Button) findViewById(R.id.b_cancelar);
        botoIniciar = (Button) findViewById(R.id.b_iniciar);
        ...
        lmt = (LaMeuaTasca2)getLastCustomNonConfigurationInstance();
        if (lmt==null){  //No hi ha cap tasca llençada anteriorment
            lmt = new LaMeuaTasca2(this); // Per tant, en crearé una nova
        }else{
             // La tasca ja s'ha llençat previament
            lmt.activityAQuiPertany=new WeakReference(this); //
    ...
    public Object onRetainCustomNonConfigurationInstance(){
        ...
        if(lmt!=null){
            lmt.activityAQuiPertany=null;  //Alliberem la WeekReference per a que la puga eliminar el GC.
            return lmt;
        }else{
    ...
    public static void actualitzaBarraIText(Integer valorBProgres, String valorText){
    ...
    //----------------------------------------------------------------------
    private static class LaMeuaTasca2 extends AsyncTask<Void, Object, Void> {
         WeakReference activityAQuiPertany;   // Guardem una referència de l'activity que llença la tasca

        public LaMeuaTasca2(Activity a){
